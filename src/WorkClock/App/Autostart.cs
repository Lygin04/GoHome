...
{
    /// <summary>Имя задачи в планировщике.</summary>
    public const string TaskName = "WorkClock";
    ...
    public static AutostartResult Enable(string executablePath)
    {
        ...
        var file = Path.Combine(Path.GetTempPath(), $"workclock-task-{Guid.NewGuid():N}.xml");
        try
        {
