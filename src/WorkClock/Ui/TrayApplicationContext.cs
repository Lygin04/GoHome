...
public sealed class TrayApplicationContext : ApplicationContext
{
    ...
    public TrayApplicationContext(WorkClockService service, Func<DateTimeOffset>? clock = null)
    {
        ...
        _notifyIcon = new NotifyIcon { Text = "WorkClock" };
    ...
    private static string Tooltip(DaySummary summary)
    {
        ...
        {
            WorkState.NotStarted => "WorkClock — день не начат",
