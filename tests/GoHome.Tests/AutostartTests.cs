...
public class AutostartTests
{
    ...
    private static XElement Xml(string exe = @"C:\Program Files\GoHome\GoHome.exe", string user = @"CONTOSO\ivan") =>
    ...
    public void Команда_указывает_на_переданный_exe()
    {
        ...
        Assert.Equal(@"C:\Program Files\GoHome\GoHome.exe", command);
    }
